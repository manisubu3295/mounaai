...
export const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn('text-[13.5px] font-semibold leading-snug text-[hsl(var(--text-primary))]', className)} {...props} />
  )
);
...
export const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn('text-[12px] text-[hsl(var(--text-secondary))]', className)} {...props} />
  )
);
